  ...
  return (
    ...
    <StatusBar style="dark" />
       ...
       <View style={{alignItems:"center",height:130}}>
         ...
         <Text style={{fontSize:32,fontWeight:400}}>OTP Verification has been successful !</Text>
        
         <Block >
         <Text style={{fontSize:24,fontWeight:400,marginTop:30}}>925 146 6235</Text>
         <Text style={{fontSize:16,fontWeight:400,marginTop:15}}>Will be used as primary contact number. You can change it later</Text>
